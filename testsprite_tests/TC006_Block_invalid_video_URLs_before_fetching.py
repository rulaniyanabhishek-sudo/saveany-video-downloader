...
async def run_test():
    ...
    try:
        ...
        # -> Enter a syntactically valid but unsupported video URL into the URL input and click the Get Video button to trigger validation.
        ...
        await elem.fill("https://example.com/watch?v=123")
