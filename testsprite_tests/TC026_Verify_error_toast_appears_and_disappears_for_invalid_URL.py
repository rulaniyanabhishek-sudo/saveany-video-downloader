...
async def run_test():
    ...
    try:
        ...
        # -> Type 'https://www.google.com' into the URL input (index 3), wait for UI reaction, then click the Get Video button (index 11).
        ...
        await elem.fill("https://www.google.com")
